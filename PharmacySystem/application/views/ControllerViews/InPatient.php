								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="text" id="firstName" class="form-control" placeholder="Enter Patient Name">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" id="mob" class="form-control" placeholder="3840375969641">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" id="mob" class="form-control" placeholder="03347551833">
